...
#define LLNET_NETIF_NAMES    {"lo0", "ml1", "ua2", "en3"}
#define PLATFORM_NETIF_NAMES {"lo0", "ml1", "ua2", "en3"}
/*number of netifs stored*/
#define NUMB_OF_NETIF_TO_STORE 4
#else
#define LLNET_NETIF_NAMES    {"ml0", "ua1", "en2"}
#define PLATFORM_NETIF_NAMES {"ml0", "ua1", "en2"}
/*number of netifs stored*/
#define NUMB_OF_NETIF_TO_STORE 3
#endif
#elif defined ENABLE_WIFI
#if (defined(LWIP_NETIF_LOOPBACK) && (LWIP_NETIF_LOOPBACK != 0))
#define LLNET_NETIF_NAMES    {"lo0", "ml1", "ua2"}
#define PLATFORM_NETIF_NAMES {"lo0", "ml1", "ua2"}
/*number of netifs stored*/
#define NUMB_OF_NETIF_TO_STORE 3
#else
#define LLNET_NETIF_NAMES    {"ml0", "ua1"}
#define PLATFORM_NETIF_NAMES {"ml0", "ua1"}
/*number of netifs stored*/
#define NUMB_OF_NETIF_TO_STORE 2
#endif
#elif defined ENABLE_ETHERNET
#if (defined(LWIP_NETIF_LOOPBACK) && (LWIP_NETIF_LOOPBACK != 0))
#define LLNET_NETIF_NAMES    {"lo0", "en1"}
#define PLATFORM_NETIF_NAMES {"lo0", "en1"}
/*number of netifs stored*/
#define NUMB_OF_NETIF_TO_STORE 2
#else
#define LLNET_NETIF_NAMES    {"en0"}
#define PLATFORM_NETIF_NAMES {"en0"}
/*number of netifs stored*/
